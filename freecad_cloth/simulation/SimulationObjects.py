...
def _resolve_pin_indices(obj, particle_count, automatic_pins=()):
    """Resolve an explicit pinning policy without silently adding constraints."""
...
def create_simulation_scene(doc):
    ...
    scene.addProperty("App::PropertyFloat", "ArrangementClearance", "Arrangement").ArrangementClearance = 2.0
    scene.addProperty("App::PropertyFloat", "MaxPlacementTranslation", "Arrangement").MaxPlacementTranslation = 250.0
