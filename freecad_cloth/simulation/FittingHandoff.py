...
This bridge copies already-authored simulation garment pieces into the
persistent fitting metadata and opens the existing Cloth Sewing stage. The
simulation DrapeTarget remains authoritative; no target proxy or solver state
is copied into a second placement/collision authority.
"""
