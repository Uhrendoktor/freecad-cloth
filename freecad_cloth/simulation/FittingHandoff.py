...
DrapeTarget is carried into the fitting stage as the same authoritative object.
"""
...
def open_arrange_fit_from_simulation(simulation):
    """Hand current simulation cloth pieces and DrapeTarget to the fitting stage."""
