...
class TissuBackend(ClothSimulationBackend):
    ...
    def __init__(
        ...
        self._signed_collision_bvh = (
            _build_signed_collision_bvh(self._source_collision_surface or self._collision_surface)
            if self._signed_collision_guard and self._collision_mode == "mesh" and (self._source_collision_surface or self._collision_surface) is not None
            else None
        )
