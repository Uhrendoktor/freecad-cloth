...
class SewingTaskPanel:
    ...
    def __init__(self,obj):
        ...
        self.reverse_button=QtWidgets.QPushButton("Reverse B"); self.reverse_button.setToolTip("Toggle the direction of seam B correspondence"); self.reverse_button.clicked.connect(self.reverse_b); layout.addRow("Actions",self.reverse_button)
