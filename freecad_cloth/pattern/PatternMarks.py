...
def add_notch():
    ...
    return add_mark(doc, "Notch", str(piece.PieceId), _native_default_segment_id(piece), 0.5, depth=3.0)
...
def add_internal_mark():
    ...
    doc = App.ActiveDocument or App.newDocument("ClothPattern")
    piece = _selected_piece(doc)
    return add_mark(doc, "InternalMark", str(piece.PieceId), _native_default_segment_id(piece), 0.5, depth=3.0, text="Internal mark")
