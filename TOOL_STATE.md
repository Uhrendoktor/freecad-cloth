...
release_gate:
  candidate: PR_1075
  exact_head: d346200094d323e3f55cab1832a7b2343aa7ee7e
  pr_run_state: no pull_request run/status; latest exact-head push run #3492 / 35867820895 failed pre-job with zero jobs/artifacts; close/reopen probe at the prior frozen head also produced no pull_request run
