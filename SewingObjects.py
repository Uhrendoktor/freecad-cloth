...
class SewingOperationProxy:
    ...
    def execute(self,obj):
        ...
        if seam is None or piece_a is None or piece_b is None:obj.Status="Incomplete";obj.LengthA=obj.LengthB=obj.LengthDifference=0.0;obj.StitchCount=0;obj.Shape=Part.Shape();return
