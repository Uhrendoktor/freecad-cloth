...
- **P0-B Sewing:** semantic seam references are merged. Remaining work: curved/M:N sewing, seam editing UI, length validation, invalid-reference UX, and sewing dependency invalidation.
...
| Export validation | #163, PR #209 | CI/review | supervisor |
| Sketcher authority | #165/#170, PR #210 | CI/review | supervisor |
...
1. Merge the validated Sketcher-authority and export gates after terminal-green CI.
