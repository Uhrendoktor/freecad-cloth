...
- Active release candidate: PR #1075, branch `supervisor/final-release-fixed-main-20260923`; exact head `5f38dcfbfd2e37bbb2d21ccd61af0ad1c7899b5b`.
...
- PR #1073 has been superseded and closed; PR #1074 and #1077 have been merged; PR #1075 is the sole open release PR; validation PR #1078 was opened against the identical candidate SHA to probe event delivery and then closed without a run; #1053 is the active external CI blocker; #1020 and #1043 remain open until their acceptance gates are verified on merged main.
