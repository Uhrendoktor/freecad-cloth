...
- Publication audit verified the live `docs/screenshots` assets' paths, dimensions, frame counts, timing, and representative rendered content. Merged-main canonical run #3987's authoritative artifact bytes were content-addressed against the published `docs/screenshots` Git blobs at commit `75226f321b303618bfff58782a1c4b93a6b56e15`; all five README assets matched exactly.
