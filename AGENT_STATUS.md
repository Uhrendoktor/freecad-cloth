...
- **#174** P1 PatternIR curved Sketcher adapter — claimed by Uhrendoktor in `agent/issue-174-pattern-ir-curves-20260829`, based on the isolated PatternIR work; adds native line/arc/BSpline/Bezier conversion without changing P0 workbench branches.
