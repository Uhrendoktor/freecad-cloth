...
- Default branch: main
- Current main: 12cb1c01681fc0fa67b6bd458736bd97bd78baad (resolved at audit time).
...
- Timing-fix PR: #1097, branch agent/issue-1088-gif-timing-20260923; head af7bbd269f275890805534f9b52f0d479bf86cea.
- Current candidate relation to main: exact release SHA is 2 commits ahead / 15 behind main; the behind side is subsequent supervisor/documentation history. Do not rebase/synchronize the frozen release SHA.
...
- PR #1097 is the sole timing-fix implementation path; its exact head af7bbd269f275890805534f9b52f0d479bf86cea also has no pull_request workflow run/status.
...
- Artifact 10743635540 contains the genuine blanket-motion.gif plus 16 motion-frame PNGs. The GIF is 16-frame 640x480 motion media, but its frame timing is 0 ms; PR #1097 adds the fail-closed timing contract, and browser playback timing remains a required gate.
...
- Release-replacement PRs #1093, #1095 and #1096 were closed unmerged so #1075 remains the sole geometry release path. Timing duplicate #1090 is closed unmerged; #1097 is the active timing path.

## Current gate

- Do not merge or close #1017 or #1094.
- Do not merge #1075 or #1097 until their respective canonical validation gates are terminal-green.
