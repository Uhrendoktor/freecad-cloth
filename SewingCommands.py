...
def create_sewing_operation():
    ...
    obj = add_sewing_operation(doc, seam, a, b, f"SewingOperation{n}"); doc.recompute(); return obj
def edit_sewing_operation():
    ...
    from SewingGui import show_sewing_task; return show_sewing_task(obj)
def validate_seams():
    import FreeCAD as App
    doc = App.ActiveDocument
    if doc is None: return []
    ops = [o for o in doc.Objects if getattr(o, "SewingType", "") == "SewingOperation"]
    for obj in ops: obj.Proxy.execute(obj)
    doc.recompute(); return [(o.Name, o.Status, float(o.LengthDifference)) for o in ops]
def show_sewing_2d():
    import FreeCADGui as Gui
...
_HANDLERS = {"ClothSewing_CreateOperation": create_sewing_operation, "ClothSewing_EditOperation": edit_sewing_operation, "ClothSewing_Validate": validate_seams, "ClothSewing_Show2D": show_sewing_2d}
try:
    import FreeCADGui as Gui
