...
class SewingTaskPanel:
    def __init__(self, obj):
        App, Gui, QtWidgets = _gui_modules(); self.App, self.Gui, self.obj = App, Gui, obj
        ...
        self.stitches = QtWidgets.QSpinBox(); self.stitches.setRange(2,10000); self.stitches.setValue(max(2,int(obj.Stitches)))
    ...
    def accept(self):
        self.obj.Tolerance=self.tolerance.value(); self.obj.Stitches=self.stitches.value(); self.App.ActiveDocument.recompute(); self._refresh(); return True
