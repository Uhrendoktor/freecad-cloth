...
def test_one_step_pattern_piece_command_is_registered_and_compatibility_alias_delegates():
    ...
    PatternCommands.create_pattern_piece = lambda: calls.append("create") or piece
    try:
...
if __name__ == "__main__":
    ...
    test_one_step_pattern_piece_command_is_registered_and_compatibility_alias_delegates()
