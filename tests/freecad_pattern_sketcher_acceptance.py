"""FreeCAD/Xvfb acceptance for native Sketcher-backed Cloth Pattern authoring."""
import math
import os
import sys
...
def main():
    ...
    try:
        # Exercise the public Pattern command: it creates the Cloth PatternPiece
        # and its authoritative native Sketcher object.
        Gui.runCommand("ClothPattern_CreatePieceWithSketch", 0)
        doc.recompute()
        piece = next(o for o in doc.Objects if getattr(o, "PatternType", "") == "PatternPiece")
        sketch = piece.Sketch
        ...
        # Add a curved boundary feature and native geometric constraints.  The
        # existing piece already contains Coincident + Horizontal + Vertical
        # constraints generated by PatternSketch.
        ...
        # Use a native named dimensional constraint as a FreeCAD expression
        # input. This verifies the Sketcher expression path rather than a Cloth
        # shadow property.
        ...
        # Save/reload is part of the public acceptance contract: semantic edge
        # IDs, native constraints, named expressions, and the PatternPiece link
        ...
        assert abs(float(reloaded_sketch.getDatum(dimension)) - 42.0) < 1e-7
