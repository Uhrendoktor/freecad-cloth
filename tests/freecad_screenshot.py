...
def pattern_and_sewing():
    ...
    close_task()
    seam = add_seam(doc, Seam(str(front.PieceId), 1, str(back.PieceId), 3, id="FrontBack", alignment="uniform", stitch_group="MainSeam")); sewing = create_sewing_operation(); doc.recompute()
