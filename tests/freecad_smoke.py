...
def main():
    ...
    validation=validate_piece(obj);assert validation["valid"] and validation["edge_count"]==4;assert obj.ValidationStatus=="Valid"
    ...
    validation=validate_piece(obj);assert validation["valid"] and abs(validation["perimeter"]-400.0)<1e-6
    ...
    print("FreeCAD workbench, native Sketcher authority, pattern validation, sewing correspondence, drape target, humanoid drape, and parametric avatar smoke test passed")
