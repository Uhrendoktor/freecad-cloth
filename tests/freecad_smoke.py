...
_PROGRESS = Path(os.environ.get("CLOTH_E2E_DIR", "/tmp")) / "freecad-smoke-progress.log"
...
def main():
    ...
    checkpoint("IMPORTED_GUI")
    import InitGui
    checkpoint("IMPORTED_INITGUI")
