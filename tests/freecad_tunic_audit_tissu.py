...
replacements = {
    ...
    'front, front_outline = make_piece("VisualTunicFront", front_y, 0.64, 0.10); back, back_outline = make_piece("VisualTunicBack", back_y, 0.64, 0.07)':
        'front, front_outline = make_piece("VisualTunicFront", front_y, 0.78, 0.18); back, back_outline = make_piece("VisualTunicBack", back_y, 0.76, 0.12); back.Placement = App.Placement(App.Vector(x_mid - hem_width / 2.0, back_y, hem_z), App.Rotation(App.Vector(0,0,1), 180.0).multiply(App.Rotation(App.Vector(1,0,0), 90.0))); back.Sketch.Placement = back.Placement',
