...
def test_native_integer_seam_reference_uses_authored_sketch_semantic_ordinal_after_shuffle():
    if App is None or Part is None:
        return
    document = App.newDocument("NativeShuffledSemanticSeam")
    try:
        ...
        document.recompute()
        seam = add_seam(document, Seam(obj_a.PieceId, 1, obj_b.PieceId, 0, id="native-shuffled-seam"))
        document.recompute()
...
if __name__ == "__main__":
    ...
    test_native_integer_seam_reference_uses_authored_sketch_semantic_ordinal_after_shuffle()
