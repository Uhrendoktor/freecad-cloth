...
def test_native_integer_seam_reference_uses_original_sketch_semantic_ordinal_after_shuffle():
    if App is None or Part is None:
        return
    document = App.newDocument("NativeShuffledSemanticSeam")
    try:
        piece_a = PatternPiece(
            "NativeShuffledA", [(0, 0), (10, 0), (10, 10), (0, 10)], id="native-shuffled-a"
        )
        piece_b = PatternPiece(
            "NativeShuffledB", [(0, 0), (10, 0), (10, 10), (0, 10)], id="native-shuffled-b"
        )
