...
try:
    ...
    assert reloaded_colors == seam_color_map(reloaded_colors)
    assert reloaded_colors == {seam_id: actual_colors[seam_id] for seam_id in reloaded_colors}
    record("seam-colors-save-reload=passed identity-stable=true")
