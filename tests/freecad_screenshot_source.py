...
def simulation():
    ...
    scene.PinPolicy = "none"; scene.PinSelection = []
    doc.recompute()
    surface = getattr(scene.Proxy, "collision_surface", None)
