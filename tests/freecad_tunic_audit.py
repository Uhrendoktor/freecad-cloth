...
replacements = {
    ...
    'scene.FabricFriction = 0.75;': 'scene.FabricFriction = 0.75;',
    ...
    'upper_margin = 0.12 * max(1.0, float(shoulder_z) - float(hem_z))': 'upper_margin = 0.12 * max(1.0, float(shoulder_z) - float(hem_z))',}
