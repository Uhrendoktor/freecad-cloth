...
replacements = {
    ...
    'for edge_a, edge_b, seam_id in ((2,2,"TunicRightShoulder"),(5,5,"TunicLeftShoulder")):' :
        ...
        '    if len(front_edge_ids) < 8 or len(back_edge_ids) < 8: raise RuntimeError("canonical tunic fixture is missing authored semantic edge IDs")\\n'
        ...
        '        add_seam(doc, seam)\\n'
        '        seam_records.append((next(o for o in doc.Objects if getattr(o, "SeamId", "") == seam_id), front, back))',
