...
replacements = {
    ...
    'for edge_a, edge_b, seam_id in ((2,2,"TunicRightShoulder"),(5,5,"TunicLeftShoulder")):' :
        ...
        '    required_edge_indices = (1, 2, 6, 7)\\n'
        '    if len(front_edge_ids) <= max(required_edge_indices) or len(back_edge_ids) <= max(required_edge_indices) or any(not front_edge_ids[index] or not back_edge_ids[index] for index in required_edge_indices): raise RuntimeError("canonical tunic fixture is missing authored semantic edge IDs")\\n'
