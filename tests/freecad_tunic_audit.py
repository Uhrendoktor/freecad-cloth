...
replacements = {
    ...
    'for edge_a, edge_b, seam_id in ((2,2,"TunicRightShoulder"),(5,5,"TunicLeftShoulder")):' :
        'for edge_a, edge_b, seam_id in ((f"{front.PieceId}:edge:2", f"{back.PieceId}:edge:2", "TunicRightShoulder"),(f"{front.PieceId}:edge:5", f"{back.PieceId}:edge:5", "TunicLeftShoulder")):',
