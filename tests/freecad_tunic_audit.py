...
replacements = {
    ...
    'scene.SolverIterations = 8;': 'scene.StitchSamples = 16; scene.ParticleDistance = 32.0; scene.SolverIterations = 1; scene.SolverSubsteps = 1; log("tunic-solver=particle-distance-32 iterations-1 stitch-samples-16 substeps-env");',
