...
replacements = {
    ...
    'for edge_a, edge_b, seam_id in ((2,2,"TunicRightShoulder"),(5,5,"TunicLeftShoulder")):' :
        'for edge_a, edge_b, seam_id in (("VisualTunicFrontSketch:edge:1","VisualTunicBackSketch:edge:1","TunicRightSide"),("VisualTunicFrontSketch:edge:2","VisualTunicBackSketch:edge:2","TunicRightShoulder"),("VisualTunicFrontSketch:edge:6","VisualTunicBackSketch:edge:6","TunicLeftShoulder"),("VisualTunicFrontSketch:edge:7","VisualTunicBackSketch:edge:7","TunicLeftSide")):',
