...
replacements = {
    ...
    'scene.SolverIterations = 8;': 'scene.ParticleDistance = 32.0; scene.SolverIterations = 1; scene.SolverSubsteps = 1; scene.StitchSamples = 16; log("tunic-solver=particle-distance-32 iterations-1 substeps-1 stitch-samples-16");',
