...
def test_canonical_tunic_uses_validated_shoulder_edge_mapping():
    ...
    assert '(("VisualTunicFrontSketch:edge:1","VisualTunicBackSketch:edge:1","TunicRightSide"),("VisualTunicFrontSketch:edge:2","VisualTunicBackSketch:edge:2","TunicRightShoulder"),("VisualTunicFrontSketch:edge:6","VisualTunicBackSketch:edge:6","TunicLeftShoulder"),("VisualTunicFrontSketch:edge:7","VisualTunicBackSketch:edge:7","TunicLeftSide"))' in source
...
def test_canonical_tunic_rejects_known_shoulder_mapping_regressions():
    ...
    assert '(("VisualTunicFrontSketch:edge:1","VisualTunicBackSketch:edge:1","TunicRightSide"),("VisualTunicFrontSketch:edge:2","VisualTunicBackSketch:edge:2","TunicRightShoulder"),("VisualTunicFrontSketch:edge:6","VisualTunicBackSketch:edge:6","TunicLeftShoulder"),("VisualTunicFrontSketch:edge:7","VisualTunicBackSketch:edge:7","TunicLeftSide"))' in audit
