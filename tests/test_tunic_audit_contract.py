...
def test_tissu_solver_step_uses_backend_owned_collision_surface():
    sim_objects = (ROOT / "freecad_cloth" / "simulation" / "SimulationObjects.py").read_text(encoding="utf-8")
    assert "_solver_collision_surface(self)" in sim_objects
