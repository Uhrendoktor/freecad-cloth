...
The tunic is the full garment acceptance scenario. It uses two pattern pieces, semantic sewing, a production MakeHuman mannequin, target-aware rigid placement, explicit no-pin simulation, persisted quality/material settings, diagnostics, save/reload and invalidation.
