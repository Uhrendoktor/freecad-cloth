...
- The three README turntable GIFs are 73 frames at 640x480 with uniform 8cs frame timing; the canonical workflow asserts that timing fail-closed. Representative rendered frames were inspected, and the final publication audit verified the live assets' structural/timing properties. Merged-main canonical run #3987 content-addressed all five README assets against the published `docs/screenshots` blobs at commit `75226f321b303618bfff58782a1c4b93a6b56e15`, with exact byte equality.
