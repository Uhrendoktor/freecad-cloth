...
The current package is 0.1.0. The P0 end-to-end workflow is the validated release-closeout scenario. Advanced commercial garment-suite capabilities remain roadmap work and are not implied by a green tunic example.
