...
class _NativePatternCommand:
    def Activated(self):
        return create_native_pattern_piece()
    def IsActive(self):
        return _active_document()
    def GetResources(self):
        return {"MenuText": "New Native Pattern Piece", "ToolTip": "Create a PatternPiece and immediately make its native Sketcher geometry authoritative"}
