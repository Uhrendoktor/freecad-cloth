...
def create_notch():
    ...
    return create_mark_from_selection("Notch")


def create_grainline():
    from PatternMarks import create_mark_from_selection
    return create_mark_from_selection("Grainline")


def create_internal_mark():
    from PatternMarks import create_mark_from_selection
    return create_mark_from_selection("Internal Mark")


def create_fold_mark():
    from PatternMarks import create_mark_from_selection
    return create_mark_from_selection("Fold")


def create_dart_mark():
    from PatternMarks import create_mark_from_selection
    return create_mark_from_selection("Dart")
...
COMMANDS = [
    ...
    "ClothPattern_CreateNotch",
    "ClothPattern_CreateGrainline",
    "ClothPattern_CreateInternalMark",
    "ClothPattern_CreateFoldMark",
    "ClothPattern_CreateDartMark",
]
...
try:
    ...
    if hasattr(Gui, "addCommand"):
        for name, handler in {
            ...
            "ClothPattern_CreateNotch": create_notch,
            "ClothPattern_CreateGrainline": create_grainline,
            "ClothPattern_CreateInternalMark": create_internal_mark,
            "ClothPattern_CreateFoldMark": create_fold_mark,
            "ClothPattern_CreateDartMark": create_dart_mark,
        }.items():
